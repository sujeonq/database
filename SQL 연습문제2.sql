...
insert into `bank_customer` values('910912-1000005','심사임당',1,'010-1234-1005','강원도 강릉시');
insert into `bank_customer` values('941127-1000006','이순신',1,'010-1234-1006','부산시 영도구');

insert into `bank_account` values('101-11-1001','S1','자유저축예금','740423-1000001',420000,'2005-07-21');
...
#실습 2-10.
select `a_no`, `a_item_dist`,`a_item_name`,`a_c_no`,`a_balance`,`a_open_date` from `bank_account`
